...
"[project]/app/api/jobs/[jobId]/download/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        if (job.status !== 'completed') {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BadRequestError"](`Cannot download job in status: ${job.status}. Job must be completed.`);
        }
        ...
        try {
            await __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["promises"].access(zipPath);
        } catch  {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NotFoundError"]('Processed files');
        }
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logger"].info(`Downloading job ${jobId}`);
        // Read file and return as response
        const fileBuffer = await __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["promises"].readFile(zipPath);
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logger"].error('Download error:', error.message);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__84046b26._.js.map