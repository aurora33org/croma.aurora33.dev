...
export function ErrorView({ message, onRetry }: ErrorViewProps) {
  ...
  return (
    <div className="py-8 sm:py-12 md:py-16 px-4 sm:px-8 md:px-16 lg:px-20 xl:px-[120px] max-w-[1720px] mx-auto mb-4 sm:mb-6 md:mb-8 text-center">
      <div className="bg-white dark:bg-container-dark rounded-none shadow-sm border border-red-200 dark:border-red-900 p-4 sm:p-6 md:p-8 lg:p-12">
        ...
        <button
          onClick={onRetry}
          className="bg-primary hover:bg-primary/90 text-white font-semibold py-3 px-8 rounded-none transition-all"
        >
          {t('retryButton')}
        </button>
      </div>
